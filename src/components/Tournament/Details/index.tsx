...
export default function TournamentKnockoutDetails({
  className,
  ...
  return (
    <Card className={twMerge("p-3 flex flex-col", className)}>
      <div className="mb-3 flex items-center justify-between gap-8 border-b pb-3 dark:border-b-neutral-600">
